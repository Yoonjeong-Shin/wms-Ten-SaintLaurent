...
class OutbClientTask implements Runnable {
    private final Socket socket;

    public OutbClientTask(Socket socket) {
        this.socket = socket;
    }

    @Override
    public void run() {
        SelOutboundService selOutboundService = new SelOutboundService();
        ...
        try {
            ...
            String message = "apiNm#selOutbOrder#" + selOutboundService.findAllOutboundOrders();
            printer.println("\n" + message);

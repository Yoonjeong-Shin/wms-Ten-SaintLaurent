...
public class SelOutResponseClient implements Runnable {
    private final Socket socket;
    private boolean flag;
    public SelOutResponseClient(Socket socket, boolean flag) {
        this.socket = socket;
        this.flag = flag;
    }
    ...
    public void run() {
        try {
            ...
            // JSON 문자열로 변환
            if(flag)
                message = "true#" + "출고가 잘 처리 됐습니다.";
            else message = "false#" + "출고가 처리 되지 않았습니다.";
            printer.println("\n" + message);

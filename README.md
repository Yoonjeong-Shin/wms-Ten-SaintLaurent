## 프로젝트 소개
**프로젝트명** : 다중 소켓 통신 기반의 스마트 화장품 WMS <br>
상품의 입고부터 출고까지 창고 운영을 효율적으로 관리하는 화장품 창고 시스템

## 팀원 구성
김도현, 나지영, 박수빈, 신윤정, 양희윤, 이용준
## Stack
- Programming : JAVA
- DB : MYSQL, JDBC, MYBATIS
- 협업 툴 : NOTION, GIT, DISCORD
- ERD 다이어그램 : ERD CLOUD
- 유스케이스, 시퀀스 다이어그램 : WHIMSICAL
## 프로젝트 구조
### ERD
...
- 나지영 : 입고 관리 CRUD, 입고 검수, 입고 확정
- 박수빈 : 재고 관리 CRUD, 재고 추가, 재고 폐기, 로케이션 할당
- 신윤정 : 출고 관리 CRUDM 출고 검수, 출고 지시서 생성, 픽킹, 카트할당
- 양희윤 : 재고 관리 CRUD, 재고 추가, 재고 폐기, 로케이션 할당
- 이용준 : 출고 관리 CRUDM 출고 검수, 출고 지시서 생성, 픽킹, 카트할당

## 개발기간 및 작업관리
- 개발기간 : 2024-05-08 ~ 2024-05-10 분석 / 기획
  2024-05-11 ~ 2024-05-18 요구사항 및 다이어그램 작성
  2024-05-16 ~ 2024-05-22 개발 및 테스트
- 작업관리 : 작업관리 : 노션 및 깃허브를 이용한 작업관리
...
## 프로젝트 후기
### 김도현
- **MyBatis와 JDBC를 활용한 WMS(Java) 프로젝트 후기**
...
### 이용준
- WMS 라는 창고 관리 시스템을 처음 접해 보아서 이해하기가 어려웠고 이번 프로젝트에서 요구하는 각종 다이어그램과 요구사항을 작성하는 과정에서 많은 시행착오가 있었던 것 같다 또한 MYBATIS 와 JDBC의 사용이 익숙치 않았고  MVC패턴의 서비스단에 로직을 짜야할지 테이블과 매핑하고 쿼리로 로직을 짜야할지에 대한 고민과 프로젝트의 테이블의 갯수가 많다보니 여러개의 DTO DAO와 연결하여 MAPPING하는 부분이 어려웠던 것 같다. 좀 더 많이 사용을 해보고 공부를 더 하고 다음 기회에 제대로 코드를 짜보고 싶다. 😂![image](https://github.com/ssg-java3-240304/wms-Ten-SaintLaurent/assets/81032378/6b58141d-20d3-4a69-8ec6-11a3ad3de1b0)# 💄텐생로랑 WMS-Ten-SaintLaurent
